...
class Args:
    def __init__(self,
                 ...
                 window_size=None, padding=22, antialias_scale=4,
                 LABEL=1, seed_distance=27, marker_radius=3,
                 contour_length=15, distractor_length=5, num_distractor_snakes=6, snake_contrast_list=None,
                 use_single_paddles=True,
                 max_target_contour_retrial=4, max_distractor_contour_retrial=4, max_paddle_retrial=2,
                 continuity=1.4, paddle_length=5, paddle_thickness=1.5, paddle_margin_list=None,
        ...
        self.window_size = window_size if window_size else [256, 256]
        ...
        self.snake_contrast_list = snake_contrast_list if snake_contrast_list else [1.]
        ...
        self.paddle_margin_list = paddle_margin_list if paddle_margin_list else [
            4]  # if multiple elements in a list, a number will be sampled in each IMAGE
        self.paddle_contrast_list = paddle_contrast_list if paddle_contrast_list else [
            1.]  # if multiple elements in a list, a number will be sampled in each PADDLE
...
if __name__ == '__main__':
    ...
    dataset_root = './generated_data'  # '/media/data_cifs/pathfinder_seg/'
